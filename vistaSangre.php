<?php
    ...
    $sentencia = $BD->prepare("SELECT * FROM sangre WHERE nombre=?");
...
<td><?php echo $pacientes->hematies ?></td>
<td><?php echo $pacientes->hemoglobina ?></td>
<td><?php echo $pacientes->hematocrito ?></td>
<td><?php echo $pacientes->vcm ?></td>
<td><?php echo $pacientes->plaquetas ?></td>
<td><?php echo $pacientes->vsg ?></td>
