<?php
    ...
    $sentencia = $BD->prepare("SELECT * FROM orina WHERE nombre=?");
...
<td><?php echo $pacientes->aldo ?></td>
<td><?php echo $pacientes->amino ?></td>
<td><?php echo $pacientes->amilasa ?></td>
<td><?php echo $pacientes->calcio ?></td>
<td><?php echo $pacientes->cloro ?></td>
<td><?php echo $pacientes->cobre ?></td>
